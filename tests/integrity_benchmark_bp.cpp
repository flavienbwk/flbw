/*
 * FLBW encryption algorithm. Integrity Benchmark Bruteforce Protection Test Program :
 * 
 * Do not be surprised if this test is slow. This is normal since protection against brute force is enabled.
 */
...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < strings.size(); i++)
    {
        ...
        flbw_enc.set_bruteforce_protection(true);
        flbw_dec.set_bruteforce_protection(true);
        flbw_enc.set_bruteforce_difficulty(100000);
        flbw_dec.set_bruteforce_difficulty(100000);
        ...
        printf("In %f seconds (enc), %f seconds (dec).\n", bchm_enc[i], bchm_dec[i]);
    }
    time_end = clock();
