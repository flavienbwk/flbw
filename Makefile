...
bindprgm:	make_libs $(LIB_PROGRAM)
			$(CC) $(CPPFLAGS) -o $(NAME_PRGM) $(MAIN_PRGM) $(LIB_PROGRAM) $(LIB_CRYPTOPP)/libcryptopp.a $(LIB_BASE64)/base64.a $(LIB_MY)/libmy.a -I $(LIB_MY)/inc

test:		make_libs $(LIB_PROGRAM)
			$(CC) $(CPPFLAGS) -o $(NAME_PRGM_TEST) $(TEST_PRGM) $(LIB_PROGRAM) $(LIB_CRYPTOPP)/libcryptopp.a $(LIB_BASE64)/base64.a $(LIB_MY)/libmy.a -I $(LIB_MY)/inc
